...
const NAV = [
  ...
  { label: "Find Opportunities", href: "/supplier/requirements", icon: ClipboardList },
  { label: "My Quotations", href: "/supplier/quotations", icon: FileText },
  { label: "Orders", href: "/supplier/orders", icon: Package },
  { label: "Ratings", href: "/supplier/ratings", icon: Star },
...
export default function SupplierDashboardShell({ children, title, subtitle }) {
                ...
                <div className="max-h-96 overflow-y-auto">
                  {notifications.notifications.length === 0 ? (
                    ...
                    notifications.notifications.map((n) => (
                      <Link
                        key={n._id}
                        href={n.link || "/supplier/dashboard"}
