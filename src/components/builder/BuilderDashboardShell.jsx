...
const NAV = [
  ...
  { label: "Discover Land", href: "/builder/discover", icon: Compass },
  { label: "Saved Land", href: "/builder/saved-land", icon: Bookmark },
  { label: "My Interests", href: "/builder/interests", icon: Users },
  { label: "Proposals", href: "/builder/proposals", icon: Handshake },
  { label: "Negotiations", href: "/builder/negotiations", icon: FileText },
  { label: "Projects", href: "/builder/projects", icon: FolderKanban },
  { label: "RERA & Verification", href: "/builder/rera", icon: ShieldCheck },
  { label: "Documents", href: "/builder/documents", icon: FileText },
  { label: "Messages", href: "/builder/messages", icon: MessageSquare },
  { label: "Suppliers", href: "/builder/suppliers", icon: Hammer },
  { label: "Requirements", href: "/builder/requirements", icon: ClipboardPlus },
  { label: "Quotations", href: "/builder/quotations", icon: ClipboardList },
  { label: "Orders", href: "/builder/orders", icon: Package },
  { label: "Buyer Leads", href: "/builder/buyer-leads", icon: ShoppingCart },
  { label: "Profile", href: "/builder/profile", icon: User },
  { label: "Settings", href: "/builder/settings", icon: Settings },
];

export default function BuilderDashboardShell({ children, title, subtitle }) {
